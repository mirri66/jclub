...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { URL: @paper.URL, abstract: @paper.abstract, authors: @paper.authors, pitch: @paper.pitch, title: @paper.title }
    end
  ...
  test "should update paper" do
    put :update, id: @paper, paper: { URL: @paper.URL, abstract: @paper.abstract, authors: @paper.authors, pitch: @paper.pitch, title: @paper.title }
    assert_redirected_to paper_path(assigns(:paper))
  end
